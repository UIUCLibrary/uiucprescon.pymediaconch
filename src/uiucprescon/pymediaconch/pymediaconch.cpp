...
PYBIND11_MODULE(
    ...
    py::class_<MediaConch::MediaConch>(m, "MediaConch")
        .def(py::init<>(), "Initialize the MediaConch library")
        .def("add_file", &MediaConch::MediaConch::add_file, "Add a file to the MediaConch library")
        .def("get_report", &MediaConch::MediaConch::get_report, "Get report for a file")
        .def("add_policy", &MediaConch::MediaConch::add_policy, "Add a policy file")
        .def("set_format", &MediaConch::MediaConch::set_format, "Set output format")
        .def("get_last_error", &MediaConch::MediaConch::get_last_error, "Get last error message");
        ;
    py::enum_<MediaConch_format_t>(m, "MediaConch_format_t")
